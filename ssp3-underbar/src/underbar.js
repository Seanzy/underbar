(function() {
  ...
  // Produce a var version of the array.
  // [1,2,2,3,3,3] -> [1,2,3]
  //[] -> []
  ...
  */
  ...
  //(checks whether all elements are truthy), if any element is falsy, it returns false (fails)
 ...
 if(iterator === undefined) {
  ...
  //   if(passing.length !== collection.length){
  //     return false;
  //   }

  //   for(var i = 0; i < collection.length; i++){
  //     if(collection[i] !== passing[i]){
  //       return false;
  //     }
  //   }
  ...
  _.extend = function(obj) { 
    // var arg = _.extend.arguments;
    var args = arguments;
      return  _.reduce(args, function(accumulator, item)
      {
        for (var key in item) {
          // if(accumulator.keys === undefined && item.keys === undefined) {
          //   return {};
          // }

          if (accumulator[key] !== undefined  && accumulator[key] === item[key]) {
